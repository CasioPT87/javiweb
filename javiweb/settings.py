"""
Django settings for javiweb project.
...
ALLOWED_HOSTS = ['javiercarratala.herokuapp.com', 'localhost', 'javiercarratala.co.uk', 'www.javiercarratala.co.uk']
...
WSGI_APPLICATION = 'javiweb.wsgi.application'
...
#permite a boto3 subir tus static files a AWS con el collectstatics
